...
public class Exercise_15_4 {
    public static void main(String[] argss) {
        try {
            ...
            System.out.println(String.format("%-4s %-10s %-10s %-5s %-20s","ID","Surname","Other Name","Leave","Poaition"));
            while (rset.next()) {
                ...
                String str = String.format("%-4s %-10s %-10s %-5s %-20s",empID,surname,otherName,leave,position);
